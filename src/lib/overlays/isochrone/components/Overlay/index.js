...
const Legend = () => (
  <div className={classNames.areas} style={{background: '#343332', color: '#fff', width: 232}}>
    <label style={{display: 'block', paddingBottom: 8, opacity: 0.7, clear: 'both'}}>Time delay in minutes:</label>
    {
      colors
  ...
  render () {
    ...
    return (
      <div>
        ...
        <GeoJSONOverlay map={map} data={stations.features[selection]} {...configs.selection} />
        <Legend />
      </div>
    )
  }
